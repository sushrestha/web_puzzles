...
function getAnswerSet(field)
{
	...
	var one = ["None"];
	var two = ["It does not have a maximum length"];
	var three = ["It does not validate the information given"];
	var four = ["It does not validate the information given"];
	var five = ["It does not have a maximum length","It does not check the formatting of the information"];
	var six = ["None"];
	var seven = ["None"];
	var eight = ["None"];
	var nine = ["It does not check the formatting of the information", "It does not have a maximum length"];
