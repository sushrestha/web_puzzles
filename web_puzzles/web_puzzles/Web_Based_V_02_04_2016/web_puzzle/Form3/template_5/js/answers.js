...
{
	var zero = ["None"];
	var one = ["It does not check the formatting of the information"];
	var two = ["It does not validate the information given"];
	var three = ["It does not have a maximum length","It does not check the formatting of the information","It does not validate the information given"];
	var four = ["It does not check the formatting of the information","It does not validate the information given"];
	var five = ["It does not check the formatting of the information"];
	var six = ["None"];
