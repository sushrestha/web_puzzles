...
function getAnswerSet(field)
{
	...
	var one = ["None"];
	var two = ["None"];
	var three = ["It does not have a maximum length"];
	var four = ["None"];
	...
	var nine = ["It does not have a maximum length","It does not check the formatting of the information","It does not validate the information given"];
