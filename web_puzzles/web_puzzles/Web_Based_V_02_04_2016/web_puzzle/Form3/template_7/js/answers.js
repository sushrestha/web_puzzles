...
function getAnswerSet(field)
{
	...
	var one = ["It does not have a maximum length","It does not check the formatting of the information","It does not validate the information given"];
	var two = ["It does not have a maximum length","It does not check the formatting of the information","It does not validate the information given"];
	var three = ["None"];
	var four = ["None"];
	var five = ["None"];
	var six = ["None"];
	var seven = ["It does not have a maximum length","It does not check the formatting of the information"];
	var eight = ["It does not have a maximum length","It does not check the formatting of the information"];
	var nine = ["None"];
