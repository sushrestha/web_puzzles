...
{
	var zero = ["It does not have a maximum length"];
	var one = ["It does not check the formatting of the information","It does not validate the information given"];
	var two = ["It does not check the formatting of the information","It does not validate the information given"];
	var three = ["It does not check the formatting of the information","It does not validate the information given"];
	var four = ["It does not check the formatting of the information","It does not validate the information given","It does not have a maximum length"];
	var five = ["None"];
	var six = ["It does not check the formatting of the information"];
	var seven = ["None"];
	var eight = ["It does not have a maximum length"];
	var nine = ["None"];
